...
*** JAVA Setup
#+begin_src emacs-lisp
  (setq JAVA_HOME_PATH "/Library/Java/JavaVirtualMachines/openjdk-17.jdk/Contents/Home/")
  ...
  (use-package lsp-java 
    ...
    (setq lsp-groovy-server-file (expand-file-name "site-lisp/lsp-server/groovy-language-server/groovy-language-server-all.jar" user-emacs-directory))
    :config
